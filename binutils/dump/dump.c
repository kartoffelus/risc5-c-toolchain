...
void readSegmentTable(void) {
  ...
  for (sn = 0; sn < execHeader.nsegs; sn++) {
    ...
    conv4FromTargetToNative((unsigned char *) &segmentTable[sn].name);
    conv4FromTargetToNative((unsigned char *) &segmentTable[sn].offs);
    conv4FromTargetToNative((unsigned char *) &segmentTable[sn].addr);
    conv4FromTargetToNative((unsigned char *) &segmentTable[sn].size);
    conv4FromTargetToNative((unsigned char *) &segmentTable[sn].attr);
  }
}
...
void readSymbolTable(void) {
  ...
  for (sn = 0; sn < execHeader.nsyms; sn++) {
    ...
    conv4FromTargetToNative((unsigned char *) &symbolTable[sn].name);
    conv4FromTargetToNative((unsigned char *) &symbolTable[sn].val);
    conv4FromTargetToNative((unsigned char *) &symbolTable[sn].seg);
    conv4FromTargetToNative((unsigned char *) &symbolTable[sn].attr);
  }
}
...
void readRelocTable(void) {
  ...
  for (rn = 0; rn < execHeader.nrels; rn++) {
    ...
    conv4FromTargetToNative((unsigned char *) &relocTable[rn].loc);
    conv4FromTargetToNative((unsigned char *) &relocTable[rn].seg);
    conv4FromTargetToNative((unsigned char *) &relocTable[rn].typ);
    conv4FromTargetToNative((unsigned char *) &relocTable[rn].ref);
    conv4FromTargetToNative((unsigned char *) &relocTable[rn].add);
  }
}
